...
class CacheTest {
   ...
   @Test
   fun saveViaJvmRepository_saveScheduled() {
      val repository = `saveViaJvmRepository_saveScheduled$createRepo`()
      repository.save(CacheContentImpl(0, 42))
      `saveViaJvmRepository_saveScheduled$assertScheduled`()
   }

   private external fun `saveViaJvmRepository_saveScheduled$createRepo`(
   ): Repository<Int, CacheContentImpl>

   private external fun `saveViaJvmRepository_saveScheduled$assertScheduled`()
